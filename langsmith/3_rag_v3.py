...
# --- CHANGE 3: Swapped ChatOpenAI for ChatGoogleGenerativeAI (Gemini) ---
...
# --- CHANGE 4: Added your project_name to the main decorator ---
@traceable(name="pdf_rag_full_run", project_name="RAG PDF App")
def setup_pipeline_and_query(pdf_path: str, question: str):
    # This setup function will now be a child run under the main trace
